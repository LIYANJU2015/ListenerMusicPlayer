...
public class HomeDiffCallBack extends DiffUtil.Callback{
    ...
    private ArrayList<YouTubeVideos.Snippet> mOldDatas, mNewDatas;//看名字

    public HomeDiffCallBack(ArrayList<YouTubeVideos.Snippet> mOldDatas, ArrayList<YouTubeVideos.Snippet> mNewDatas) {
