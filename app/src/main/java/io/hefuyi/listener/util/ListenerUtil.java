...
public class ListenerUtil {
    ...
    public static final String RECOMMEND_PACKAGE_NAME1 = "com.gomusic.freedownloader";
    public static final String RECOMMEND_PACKAGE_NAME2 = "com.gomusic.musicdownloader";
