...
public class AnalogController extends View {
    ...
    public static int themeColor = ATEUtil.getThemePrimaryColor(ListenerApp.sContext);
...
//        linePaint.setColor(Color.parseColor("#FFA036"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = (int) (deg2); i < 22; i++) {
            ...
            circlePaint.setColor(Color.parseColor("#44474f"));
        ...
        canvas.drawText(label, midx,DensityUtil.dip2px(getContext(), 3)+ midy + (float) (radius * 1.1), textPaint);
